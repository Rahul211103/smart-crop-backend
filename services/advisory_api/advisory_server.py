...
def chatbot():
    try:
        ...
        language_instructions = {
            'hi': "आप एक विशेषज्ञ कृषि सलाहकार हैं। हिंदी में विस्तृत और व्यावहारिक उत्तर दें।",
            'kn': "ನೀವು ತಜ್ಞ ಕೃಷಿ ಸಲಹೆಗಾರರು. ಕನ್ನಡದಲ್ಲಿ ವಿವರವಾದ ಮತ್ತು ಪ್ರಾಯೋಗಿಕ ಉತ್ತರವನ್ನು ನೀಡಿ।",
            'te': "మీరు నిపుణ వ్యవసాయ సలహాదారుడు. తెలుగులో వివరణాత్మకమైన మరియు ఆచరణాత్మకమైన సమాధానం ఇవ్వండి.",
            'ta': "நீங்கள் நிபுண விவசாய ஆலோசகர். தமிழில் விரிவான மற்றும் நடைமுறை பதிலை வழங்குங்கள்.",
            'en': "You are an expert farming advisor. Provide detailed and practical answers in English."
        }
...
Context: This is a smart crop advisory system. The user is asking about farming, agriculture, crops, soil, weather, pests, diseases, irrigation, or related topics.

Please provide:
1. A clear, detailed answer to their question
2. Practical advice they can implement
3. Additional helpful tips if relevant
4. Any warnings or precautions if needed

Make your response conversational, helpful, and easy to understand.
